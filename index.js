...
//     console.log('Hitting verift JWT');
...
//     console.log(token);
//     // এইবার আমরা token কে verify করবো।
...
async function run() {
    try {
        ...
        // services collection in carDoctorDB from mongoDB
        ...
        // Read some booking data with email specific from DB
        ...
        // Update a booking data from client side to DB
